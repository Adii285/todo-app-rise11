...
function CreateTask() {
    ...
    // }
    return (
        <div style={{marginTop:100}} className="addContainer md:w-1/3 md:mx-auto mx-3 mt-3 flex justify-center">
            <div className='w-11/12'>
                <form onSubmit={handleAdd}>
                    <div>
                        <label style={{color:'white', border:'none'}} htmlFor="title">Title</label>
                        <input
                            type="text"
                            name="title"
                            id="title"
                    ...
                    <div className='my-3'>
                        <label style={{color:'white', border:'none'}} htmlFor="description">Description</label>
                        <textarea
                            rows={5}
                            name="description"
                            id="description"
