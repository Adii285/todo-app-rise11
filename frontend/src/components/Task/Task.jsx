...
function Task({ task, id }) {
    ...
    return (
        <div style={{backgroundColor:'#8CD4CB'}} className='bg-slate-300 py-4 rounded-lg shadow-md flex items-center justify-center gap-2 mb-3'>
            ...
            <div className="remove-task text-sm text-white">
                <DeleteIcon
                    style={{ fontSize: 30, cursor: "pointer", color:'#F5E44F', backgroundColor:'#1b1b1b', borderColor:'#1b1b1b' }}
                    size="large"
