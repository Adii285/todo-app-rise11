    ...
    return (
        <div>
            ...
            <section className="register-container">
                <div style={{marginTop:-50}} className="container px-6 py-12 h-full">
                    <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
                        <div className="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
                            ...
                            <svg class="stack" width="502" height="389" viewBox="-20 -65 302 389" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="8.45782" y="177.006" width="138" height="188" rx="18" transform="rotate(-40.3888 8.45782 177.006)" fill="#F6A89E" stroke="#33322E" stroke-width="12"></rect><rect x="61.45" y="87.6386" width="138" height="188" rx="18" transform="rotate(-22.7249 61.45 87.6386)" fill="#8CD4CB" stroke="#33322E" stroke-width="12"></rect><rect x="136.422" y="22.1952" width="138" height="188" rx="18" transform="rotate(-6.47285 136.422 22.1952)" fill="#F4D799" stroke="#33322E" stroke-width="12"></rect><path d="M183 108.584L208.837 134.476L250 73.4761" stroke="#33322E" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            <h1 class="typewriter" style={{color:'#F8F8F8', fontWeight:'bold', fontSize:50, marginLeft:100, marginTop:16, width:'fit-content'}}> <span>&#62;</span> to-do-mate</h1>
                        </div>
                        <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
                        <div style={{marginLeft:-210, marginTop: 52}} className="flex items-center my-4 before:flex-1 before:mt-0.5 after:flex-1 after:mt-0.5">
                                    <p style={{color:"white", fontSize: 50}} className="text-center font-semibold mx-4 mb-0">Register Now</p>
                                </div>
